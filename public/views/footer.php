<footer class="footer content-flex" style="background-color: var(--gray);">
    <div class="content-column gap-5-h">
        <a href="#main" class="icon hover-scale"><img src="public/icons/webp_compressed/coffee-cup.webp" alt="Logo" loading="lazy"></a>
        ...
        <p>
            All rights reserved &copy; <?php echo date("Y") ?> by <a href="Kamil Urbanowski" class="rights-name">Kamil Urbanowski</a>
        </p>
    </div>
</footer>
